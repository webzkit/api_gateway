...
from schemas.avatar_service.geographies.ward import (
...
@route(
    ...
    response_model=None,
    response_list=True,
    cache_key_prefix="avatar:geography:ward:results:items_per_page_{items_per_page}:page_{page}",
...
@route(
    ...
    response_model=None,
    response_list=False,
    cache_key_prefix="avatar:geography:ward:result",
